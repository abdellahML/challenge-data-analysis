...
You can find the `challenge-data-analysis.pdf` with some explanations of the results, but you can have more visualization if you run the files by yourself.  
